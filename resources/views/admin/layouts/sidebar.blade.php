	...
	<div class="sidebar">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item" id="productsDropdown">
					...
					<ul class="nav nav-treeview" id="productsMenu" style="display: none;">
						<li class="nav-item">
						...
						<li class="nav-item">
							<a href="{{ route('products.index') }}" class="nav-link" onclick="setActiveLink(this)">
								<i class=""></i>
								<p>PRODUCTS LIST</p>
							</a>
						</li>
