        ...
        <div class="card">
            <form action="" method="get">
                <div class="px-3 py-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="product_title">Product Slug</label>
                                <input type="text" class="form-control" id="product_title">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 text-right" style="margin-top: 32px;">
                            <input type="submit" class="btn btn-default" name="search" value="search">
                            <input type="submit" class="btn btn-default" name="search" value="reset">
                        </div>
                    </div>
            ...
            <div class="px-3 py-0">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <span class="badge bg-primary">Total Product: </span>
                </div>
